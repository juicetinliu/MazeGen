class Pathfinder{
  ...
  display(cellSpacing){
    ...
    if(this.targetCell !== null){
      fill(255,255,0);
      rect((this.targetCell.x+0.1)*cellSpacing, (this.targetCell.y+0.1)*cellSpacing, cellSpacing*0.8, cellSpacing*0.8);
    }
    fill(255,0,255);
    rect((this.currCell.x+0.1)*cellSpacing, (this.currCell.y+0.1)*cellSpacing, cellSpacing*0.8, cellSpacing*0.8);
